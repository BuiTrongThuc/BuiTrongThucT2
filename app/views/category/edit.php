...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <div>
        <h2 class="fw-bold mb-1">Sửa danh mục</h2>
        <p class="text-secondary mb-0">Cập nhật thông tin danh mục</p>
    </div>
...
<div class="form-shell p-4">
    <form method="post">
        ...
        <button type="submit" class="btn btn-danger rounded-pill px-4 fw-bold">Cập nhật</button>
    </form>
</div>
